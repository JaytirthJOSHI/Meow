// MeowLang Demo Frontend JavaScript
// Now uses the web-based interpreter
...
purr             🐾 Output second cell (2)`,
        ...
        'fibonacci': `meow meow meow meow meow  🐾 Set initial value to 5
right            🐾 Move to second cell
meow meow meow meow meow meow meow meow  🐾 Set second cell to 8
left             🐾 Move back to first cell
yowl            🐾 Start loop
...
function showTips() {
    const tips = [
        ...
        "💡 This demo runs entirely in your browser - no server needed!"
    ];
    
    console.log('MeowLang Tips:');
